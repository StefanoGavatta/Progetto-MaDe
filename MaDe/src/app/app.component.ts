...
@Component({
  ...
  imports: [RouterOutlet,FooterComponent,ScuolaSpecificaComponent,CalendarioComponent,MapsComponent,PaginaSitoComponent,  HeaderComponent, HeroSectionComponent, HeroSection2Component, ScuoleComponent],
